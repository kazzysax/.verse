        ...
        <div className="mx-auto flex max-w-[900px] items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="absolute right-1.5 top-1.5 size-2.5 rounded-full bg-fuchsia-500 ring-2 ring-[#131526]" />
            </button>
            <button type="button" aria-label="Profile" className="rounded-full p-0.5 verse-gradient">
              <Person initials="KO" tone="from-cyan-400 via-violet-500 to-fuchsia-500" className="size-11 ring-2 ring-[#11131d]" />
            </button>
          </div>
        </div>
      </header>
      ...
      <main className="relative z-10 mx-auto max-w-[900px] px-4 pb-28 pt-10 sm:px-8 sm:pt-12">
        <section className="text-center">
          <div className="flex items-center justify-center gap-2">
            <h1 className="text-3xl font-extrabold tracking-[-0.06em] sm:text-4xl">kingsley.verse</h1>
          ...
          <div className="relative overflow-hidden rounded-[38px] border border-white/[.08] bg-gradient-to-b from-[#1c1f2d] via-[#10121a] to-[#090a0f] px-5 pb-5 pt-8 shadow-[0_35px_100px_rgba(0,0,0,.55)] sm:px-8 sm:pb-8">
            ...
            <div className="relative text-center">
              ...
              <div className="mt-4 flex justify-center gap-4 text-xs font-semibold text-white/55">
                <span>1,274.50 USDC</span>
                <span>43,820 VERSE</span>
              </div>
